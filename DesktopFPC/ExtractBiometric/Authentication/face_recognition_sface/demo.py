...
if __name__ == '__main__':
    ...
    img1 = cv.resize(img1,[320,320],interpolation=cv.INTER_AREA)
    img2 = cv.resize(img2, [320,320], interpolation=cv.INTER_AREA)
    # Detect faces
    ...
    # Match
    result,score = recognizer.match(img1, face1[0][:-1], img2, face2[0][:-1])
